class AlephLayer
{
    constructor()
    {
        ...
        this.upgrades = {
            alephGain: new AlephUpgrade("Increase your byte gain", level => Decimal.pow(1.215, level).mul(100),
                level => Decimal.pow(1.2 + game.restackLayer.permUpgrades.aleph.apply(), level)),
            alephGainBonus: new AlephUpgrade("Get a Bonus to byte gain",
            ...
            alephBoost: new AlephUpgrade("Gain more bytes based on the log(bytes) you have",
            ...
            deltaBoost: new AlephUpgrade("Gain more L4",
            ...
            alephBoost2: new AlephUpgrade("Gain more aleph based on the log(log(L1)) you have",
            ...
            betterBetaFormula: new AlephUpgrade("The L2 Prestige Formula is better",
            ...
            layerExponentialBoost: new AlephUpgrade("Increase the exponential difference of boosts between layers, resulting in a sussy boost!",
