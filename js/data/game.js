const game = {
    ...
    achievements: [
        ...
        new Achievement("Oκay?", "Go &lambda;", "&lambda;", () => game.layers[9] && game.layers[9].timesReset > 0),
        ...
        new Achievement("It never Ends", "Reach Layer 1.00e10", "<span style='font-size: 20%;'><span>Ω<sub>ϝ</sub></span><sup>ρ</sup>↑<span>Ω<sub>ϙ</sub></span><sup>Ν</sup>↑<span>Ω<sub>ϛ</sub></span><sup>κ</sup>↑<span>Ω</span><sup>Σ</sup></span>", () => game.metaLayer.layer.gte(1e10)),
        ...
        new Achievement("It truly never Ends", "Reach Layer 1e100", "<span style='font-size: 20%;'><span>2Ω<sub>ϝ</sub></span><sup>ρ</sup>↑<span>Ω<sub>ϙ</sub></span><sup>Ν</sup>↑<span>Ω<sub>ϛ</sub></span><sup>κ</sup>↑<span>Ω</span><sup>Σ</sup></span>", () => game.metaLayer.layer.gte(1e100)),
    ...
    secretAchievements: [
        ...
        new Achievement("No Challanges Challenge", "Get &epsilon; without completing any challenges", "<img alt=\"LC\" class=\"inline\" src=\"images/layercoin.svg\"/>", () => (functions.maxLayerUnlocked()) >= 4 && game.layers[2].challenges[0].level == 0 && game.layers[2].challenges[1].level == 0 && game.layers[2].challenges[2].level == 0 && game.layers[2].challenges[3].level == 0 && game.layers[2].challenges[4].level == 0 && game.layers[3].challenges[0].level == 0 && game.layers[3].challenges[1].level == 0 && game.layers[3].challenges[2].level == 0 && game.layers[3].challenges[3].level == 0 && game.layers[3].challenges[4].level == 0 && game.layers[3].challenges[5].level == 0),
