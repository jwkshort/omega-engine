const game = {
    ...
    achievements: [
        ...
        new Achievement("Endgame", "Reach layer 1e314 and finish Omega Layers EZ", "Ʊ", () => game.metaLayer.layer.gte("1e314")),
    ],
    secretAchievements: [
        ...
        new Achievement("Aleph-e", "Have 2.71e8281 aleph", "&aleph;<sub>e</sub>", () => game.alephLayer.aleph.gte("2.71e8281")),
