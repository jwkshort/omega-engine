const game = {
    ...
    achievements: [
        ...
        new Achievement("A Square of Generators", "Buy 1 <span>&alpha;<sub>4</sub></span> Generator", "<span>&alpha;<sub>4</sub></span>", () => game.layers[0] && game.layers[0].generators[3].bought.gt(0)),
        new Achievement("Pentagen", "Buy 1 <span>&alpha;<sub>5</sub></span> Generator", "<span>&alpha;<sub>5</sub></span>", () => game.layers[0] && game.layers[0].generators[4].bought.gt(0)),
        new Achievement("Power of Six", "Buy 1 <span>&alpha;<sub>6</sub></span> Generator", "<span>&alpha;<sub>6</sub></span>", () => game.layers[0] && game.layers[0].generators[5].bought.gt(0)),
        new Achievement("Heavenly Seven", "Buy 1 <span>&alpha;<sub>7</sub></span> Generator", "<span>&alpha;<sub>7</sub></span>", () => game.layers[0] && game.layers[0].generators[6].bought.gt(0)),
        new Achievement("Octacore", "Buy 1 <span>&alpha;<sub>8</sub></span> Generator", "<span>&alpha;<sub>8</sub></span>", () => game.layers[0] && game.layers[0].generators[7].bought.gt(0)),
        new Achievement("Nien!", "Buy 1 <span>&alpha;<sub>9</sub></span> Generator", "<span>&alpha;<sub>9</sub></span>", () => game.layers[0] && game.layers[0].generators[8].bought.gt(0)),
        new Achievement("The end of Idling?", "Buy 1 <span>&alpha;<sub>10</sub></span> Generator", "<span>&alpha;<sub>10</sub></span>", () => game.layers[0] && game.layers[0].generators[9].bought.gt(0)),
        ...
        new Achievement("Genarating Power", "Buy 1 <span>&beta;<sub>P<sub>1</sub></sub></span> Generator", "<span>&beta;<sub>P<sub>1</sub></sub></span>", () => game.layers[1] && game.layers[1].powerGenerators[0].bought.gt(0)),
        new Achievement("Polynomial Power", "Buy 1 <span>&beta;<sub>P<sub>2</sub></sub></span> Generator", "<span>&beta;<sub>P<sub>2</sub></sub></span>", () => game.layers[1] && game.layers[1].powerGenerators[1].bought.gt(0)),
        new Achievement("In Thousands", "Buy 1,000 <span>&alpha;<sub>1</sub></span> Generator", "<span>&alpha;<sub>1</sub></span>", () => game.layers[0] && game.layers[0].generators[0].bought.gt(1000)),
        ...
        new Achievement("A Square of Power", "Buy 1 <span>&beta;<sub>P<sub>4</sub></sub></span> Generator", "<span>&beta;<sub>P<sub>4</sub></sub></span>", () => game.layers[1] && game.layers[1].powerGenerators[3].bought.gt(0)),
        new Achievement("Another Layer?!", "Reach 1.00e20 &beta;", "&beta;", () => game.layers[1] && game.layers[1].resource.gte(1e20)),
        new Achievement("A Cube of Power", "Buy 1 <span>&beta;<sub>P<sub>8</sub></sub></span> Generator", "<span>&beta;<sub>P<sub>8</sub></sub></span>", () => game.layers[1] && game.layers[1].powerGenerators[7].bought.gt(0)),
        new Achievement("Other Times Await... Again", "Go &gamma;", "&gamma;", () => game.layers[2] && game.layers[2].timesReset > 0),
        new Achievement("Gamma Power", "Buy 1 <span>&gamma;<sub>P<sub>1</sub></sub></span> Generator", "<span>&gamma;<sub>P<sub>1</sub></sub></span>", () => game.layers[1] && game.layers[1].powerGenerators[0].bought.gt(0)),
        ...
        new Achievement("Aleph-π", "Have 3.14e1592 aleph", '<span class="aleph">&aleph;<sub>π</sub></span>', () => game.alephLayer.aleph.gte("3.14e1592")),
        ...
        new Achievement("Super Upgradalicious", "Max all the non-meta upgrades", "↑<sub>↑<sub>↑</sub></sub>", () => (Object.values(game.restackLayer.permUpgrades).filter(u => u.level.gt(0)).length + Object.values(game.restackLayer.permUpgrades).filter(u => u.level.gt(1)).length) == 12),
        ...
        new Achievement("(softcapped) speed", "Advance ~1.8e308 Layers per second", "<span>»<sub>&#8734;</sub></span>", () => game.metaLayer.getLayersPS().gte(299792458)),
        new Achievement("ƒ(x) = 1", "Reach 1 &#0131;P", '<span class="aleph">&#0131;<sub>1</sub></span>', () => game.functionsLayer.functionsPoints.gte(1)),
        new Achievement("ƒ(x) = 2", "Reach 1,000,000 &#0131;P", '<span class="aleph">&#0131;<sub>2</sub></span>', () => game.functionsLayer.functionsPoints.gte(1e6)),
        new Achievement("ƒ(x) = 3", "Reach 1.00e100 &#0131;P", '<span class="aleph">&#0131;<sub>3</sub></span>', () => game.functionsLayer.functionsPoints.gte(1e100)),
    ...
    secretAchievements: [
        ...
        new Achievement("The Ladder is Actually Infinite", "Reach Layer 1000 without going meta", "<img alt=\"LC\" class=\"inline\" src=\"images/layercoin.svg\"/>", () => game.highestLayer >= 999 && !game.metaLayer.active),
        ...
        new Achievement("Aleph-e", "Have 2.71e8281 aleph", "<span>&aleph;<sub>e</sub></span>", () => game.alephLayer.aleph.gte("2.71e8281")),
        new Achievement("Much Aleph, Much wow Original", "Have 1.00e10000 aleph", "&aleph;", () => game.alephLayer.aleph.gte("1e10000")),
