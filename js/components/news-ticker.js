    ...
    data: function()
    {
        return {
            messages: [
                ...
                "this news ticker will be deleted if Superspruce see this",
                ...
                "ew sticker",
                "i use break_eternity.js",
                "i use break_eternity.sb3",
                ...
                "What's make me a good modder? if i were a bad modder i wouldn't put this news in this mod.",
                "newsticker",
                "Good Game...",
                ...
                Utils.createRandomWord(175) + " sorry i steal code from sus gaem",
