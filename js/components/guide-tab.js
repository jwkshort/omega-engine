Vue.component("guide-tab", {
    computed: {
        ...
        numberUnlocked: () => game.functionsLayer.upgrades.UnlockNumber.level.gte(1)
    },
    methods: {
    ...
    <guide-item>
        ...
        <template v-slot:text>Welcome to Omega Layers EZ a mod for Omega Layers by JeehanMoment, your Goal is to produce Resources (e.g. &alpha;) and Prestige for higher Resources. You can buy
        ...
        produces 1 &alpha; every second. Continue buying Generators to increase your &alpha; production.
        </template>
    </guide-item>
    <guide-item>
    ...
    <guide-item>
        ...
        can be spent on various things to make progress faster. You will gain your second &beta; at about {{formatNumber(1.68e31, 2, 0)}} &alpha;</template>
    </guide-item>
    ...
    <guide-item v-if="functionsUnlocked">
        <template v-slot:title>Functions</template>
        <template v-slot:text>After Reaching Layer 1.8e308 once, you can start gaining <b>Functions Points</b> which are making all Resource Multipliers stronger<br> You can also use them to buy Upgrades, Variables or Functions that globally boost the game.<br> Your Layer also boost your functions gain by log<sub>2</sub>(x)-1024
        </template>
    </guide-item>
