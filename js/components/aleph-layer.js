...
<div class="resource">
    <p>You have {{formatNumber(aleph.aleph, 3, 3, 1e9)}} <span class="aleph">ℵ</span></p>
    <p>You get {{formatNumber(aleph.getAlephGain(), 3, 3, 1e9)}} <span class="aleph">ℵ</span> every second</p>
</div>
<div class="boosts">
    <div v-if="canProduceAleph">
        <p>Your highest Layer is <resource-name :layerid="highestLayer()"></resource-name>, translated to a x{{formatNumber(aleph.getAlephBoostFromLayer(), 3, 3)}} Boost on <span class="aleph">ℵ</span> gain</p>
    </div>
    <div v-else>
