...
<div class="resource">
    <p>You have {{formatNumber(aleph.aleph, 2, 2, 1e9)}}<span class="aleph">B</span></p>
    <p>You get {{formatNumber(aleph.getAlephGain(), 2, 2, 1e9)}}<span class="aleph">B</span> every second</p>
</div>
<div class="boosts">
    ...
    <div v-else>
        <p>You need to go <resource-name :layerid="3"></resource-name> at least once to get <span class="aleph">bytes</span></p>
    </div>
</div>
<div class="tabs">
